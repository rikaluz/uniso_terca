...
#nullable restore
#line 48 "C:\Users\danil\OneDrive\Área de Trabalho\Nova pasta\Grupo-04\BlazorWasm.FrontEnd\Pages\Carros\IndexCarro.razor"
    ...
    public async Task Localizar(string Marca)
    {
       Carro = await  repositorio.Get(Marca);
